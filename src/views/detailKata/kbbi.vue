	...
	<div class="kbbi">
		<b-card class="text-left">
			<h1 class="mb-0 text-left section-label">
				Arti kata <em>{{ kata }}</em> KBBI Kamus Bahasa Indonesia
			</h1>
			...
			<div class="text-left" v-for="kata in dataKata.kbbi" :key="kata._id">
				<b-card class="capital">
					<h1 class="card-title">
						<em class="text-black">Arti Kata</em> {{ kata.kata }}
					</h1>
					<b-card-text>
